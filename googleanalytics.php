...
/**
 * Plugin Name: Disciple Tools Google Analytics
 * Plugin URI:
...
if ( !defined( 'GA_PLUGIN_DIR' ) ) {
	define( 'GA_PLUGIN_DIR', WP_PLUGIN_DIR . '/disciple-tools-analytics' );
}
if ( !defined( 'GA_PLUGIN_URL' ) ) {
	define( 'GA_PLUGIN_URL', WP_PLUGIN_URL . '/disciple-tools-analytics' );
}
